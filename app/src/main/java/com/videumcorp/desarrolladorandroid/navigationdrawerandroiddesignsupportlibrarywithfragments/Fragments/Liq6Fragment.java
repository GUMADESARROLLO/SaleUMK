...
public class Liq6Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_liq6, container, false);
        ((MainActivity) getActivity()).getSupportActionBar().setTitle("LIQ6 [UMK]");
    ...
    public void CallInve(){
        ...
        Cnx.post(ClssURL.getURL_liq6(), paramentros, new AsyncHttpResponseHandler() {
            @Override
