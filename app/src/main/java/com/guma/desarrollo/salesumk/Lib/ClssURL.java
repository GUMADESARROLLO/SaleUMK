...
public class ClssURL
{
    ...
    public static String getURL_AsynRecibo() { return URL_AsynRecibo; }
    public static String getURL_Pedido() { return URL_Pedido; }
    public static String getURL_doom() { return URL_doom; }
    public static String getUrlInve() { return URL_INVE; }
    public static String getURL_login() { return URL_login; }
    public static String getURL_liq6() { return URL_liq6; }
    public static String getURL_liq12() { return URL_liq12; }
